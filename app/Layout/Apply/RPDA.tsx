    ...
    try {
      ...
      const uploadedUrls = await Promise.all(
        selectedImages.map(async (uri) => {
          ...
          const filename = `removable_partial_denture/${Date.now()}_${Math.random()}.jpg`;
      ...
      await set(newRequestRef, {
        user: userEmail,
        type: "Removable Partial Denture",
      ...
      <Modal visible={successModalVisible} transparent animationType="slide">
        <View style={styles.modalOverlay}>
          <View style={[styles.modalContent, { alignItems: 'center' }]}>
            ...
            <Text style={styles.successSub}>Your RPD request has been sent successfully.</Text>
            <TouchableOpacity 
