      ...
      <Modal visible={successModalVisible} transparent animationType="slide">
        <View style={styles.modalOverlay}>
          <View style={[styles.modalContent, { alignItems: 'center' }]}>
            ...
            <Text style={styles.successSub}>Your Bleaching request has been sent successfully.</Text>
            <TouchableOpacity 
...
const styles = StyleSheet.create({
  ...
  closeButton: { marginTop: 20, backgroundColor: '#4A148C', padding: 15, borderRadius: 12, alignItems: 'center' },
